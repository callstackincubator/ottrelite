import { TracingAPI } from '@ottrelite/core';
...
import { ExternallyDrivenComponentProps } from '../types/ExternallyDrivenComponentProps';
...
export type InstrumentationExternallyDrivenPropsDemoScreenProps = {
  hookAPI: TracingAPI;
  TracedFunctionComponent: React.FC<ExternallyDrivenComponentProps>;
  TracedClassComponent: React.ComponentClass<ExternallyDrivenComponentProps>;
  TracedFunctionComponentWithAttributes: React.FC<ExternallyDrivenComponentProps>;
};

export function InstrumentationExternallyDrivenPropsDemoScreen({
  hookAPI,
  TracedFunctionComponent,
  TracedClassComponent,
  TracedFunctionComponentWithAttributes,
}: InstrumentationExternallyDrivenPropsDemoScreenProps) {
  ...
  return (
    <>
      ...
      >
        JS React Instrumentation Demo (API: {hookAPI})
      </Text>
      ...
      <View style={[commonStyles.spanningContainer, styles.controlsWrapper]}>
        ...
        <View style={commonStyles.spanningContainer}>
          <Text variant="bodyMedium" style={commonStyles.centeredText}>
            ...
            Babel plugin @ottrelite/instrumentation-react 'use trace {hookAPI}'
            directive.
          </Text>
