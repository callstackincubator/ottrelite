...
{
    class ReactNativeOttrelite : public HybridReactNativeOttreliteSpec, public Ottrelite
    {
      public:
        /**
        ...
        /**
         * \copydoc Ottrelite::beginAsyncEvent
         */
        ...
        /**
         * \copydoc Ottrelite::endAsyncEvent
         */
        ...
        /**
         * \copydoc Ottrelite::counterEvent
         */
        ...
        void reviveSystraceAPI() override;

        std::shared_ptr<Promise<ExportResult>> exportSpans(const std::vector<SerializedReadableSpan> &spans) override;
