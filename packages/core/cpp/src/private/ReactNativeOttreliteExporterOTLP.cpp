#include "ReactNativeOttreliteExporterOTLP.hpp"
...
{
    ReactNativeOttreliteExporterOTLP::ReactNativeOttreliteExporterOTLP() : HybridObject(TAG)
    {
    }

    ReactNativeOttreliteExporterOTLP::~ReactNativeOttreliteExporterOTLP()
    {
        // unregister the exporter with Ottrelite
        ::ottrelite::otel::OttreliteOTELInterop::unregisterOTELSpanExporter(otlpExporterPtr_);
        ::ottrelite::otel::OttreliteOTELInterop::unregisterOTELMetricExporter(metricExporterPtr_);
        ::ottrelite::otel::OttreliteOTELInterop::unregisterOTELLogRecordExporter(logExporterPtr_);
    }

    void ReactNativeOttreliteExporterOTLP::initExporter(const OTLPExporterConfig &config)
    {
        initTracer(config);
        initMetrics(config);
        initLogger(config);
    ...
    void ReactNativeOttreliteExporterOTLP::initTracer(const OTLPExporterConfig &config)
    {
        ...
        ::ottrelite::otel::OttreliteOTELInterop::registerOTELSpanExporter(otlpExporterPtr_);
    }

    void ReactNativeOttreliteExporterOTLP::initMetrics(const OTLPExporterConfig &config)
    {
        ...
        // register the exporter with Ottrelite
        ::ottrelite::otel::OttreliteOTELInterop::registerOTELMetricExporter(metricExporterPtr_);
    }

    void ReactNativeOttreliteExporterOTLP::initLogger(const OTLPExporterConfig &config)
    {
        ...
        // register the exporter with Ottrelite
        ::ottrelite::otel::OttreliteOTELInterop::registerOTELLogRecordExporter(logExporterPtr_);
    }

    void ReactNativeOttreliteExporterOTLP::fillCommonConfigAttrs(const OTLPExporterConfig &source,
    ...
    std::string ReactNativeOttreliteExporterOTLP::suffixEndpoint(const std::string &endpoint, const std::string &suffix)
    {
    ...
    void ReactNativeOttreliteExporterOTLP::exportSpans(
    ...
    std::shared_ptr<Promise<void>> ReactNativeOttreliteExporterOTLP::shutdown()
    {
    ...
    std::shared_ptr<Promise<void>> ReactNativeOttreliteExporterOTLP::forceFlush()
    {
        return Promise<void>::async([this]() -> void {
            if (otlpExporterPtr_)
            {
