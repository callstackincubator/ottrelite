...
namespace ottrelite::otel
{
    ...
    std::vector<std::unique_ptr<opentelemetry::sdk::trace::Recordable>> SpanConverter::convertSpans(
        const std::vector<margelo::nitro::ottrelite::SerializedReadableSpan> &spans, ResourcesMemory &resourcesMemory)
    {
    ...
    opentelemetry::trace::SpanKind SpanConverter::convertSpanKind(margelo::nitro::ottrelite::SpanKind kind)
    {
        switch (kind)
        {
        case margelo::nitro::ottrelite::SpanKind::INTERNAL:
            return opentelemetry::trace::SpanKind::kInternal;

        case margelo::nitro::ottrelite::SpanKind::SERVER:
            return opentelemetry::trace::SpanKind::kServer;

        case margelo::nitro::ottrelite::SpanKind::CLIENT:
            return opentelemetry::trace::SpanKind::kClient;

        case margelo::nitro::ottrelite::SpanKind::PRODUCER:
            return opentelemetry::trace::SpanKind::kProducer;

        case margelo::nitro::ottrelite::SpanKind::CONSUMER:
        ...
        margelo::nitro::ottrelite::SpanStatusCode statusCode)
    {
        switch (statusCode)
        {
        case margelo::nitro::ottrelite::SpanStatusCode::OK:
            return opentelemetry::trace::StatusCode::kOk;

        case margelo::nitro::ottrelite::SpanStatusCode::ERROR:
            return opentelemetry::trace::StatusCode::kError;

        default:
        case margelo::nitro::ottrelite::SpanStatusCode::UNSET:
        ...
        return std::visit(
            [](const auto &v) -> opentelemetry::common::AttributeValue {
                ...
                else
                {
                    ...
                    std::cout << "[ReactNativeOttreliteExporterOTLP::convertVariantToAttributeValue] Unknown variant "
                                 "type received: "
