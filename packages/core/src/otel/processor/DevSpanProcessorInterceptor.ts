...
/**
 * Span processor that does not export spans or process their attributes, but instead
 * passes those events live (synchronously) to Ottrelite's Development API.
 *
...
export class DevSpanProcessorInterceptor implements SpanProcessor {
  ...
  onEnd(span: Span): void {
    ...
    Ottrelite.endAsyncEvent(span.name, token, additionalArgs);
  }
