...
#include "HybridReactNativeOttreliteInteropOTELExporterOTLPSpec.hpp"
...
namespace margelo::nitro::ottrelite::interop::otel
{
    ...
    class ReactNativeOttreliteInteropOTELExporterOTLP : public HybridReactNativeOttreliteInteropOTELExporterOTLPSpec
    {
      public:
        /**
