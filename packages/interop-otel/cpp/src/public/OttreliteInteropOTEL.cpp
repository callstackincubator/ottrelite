...
{
    void OttreliteInteropOTEL::registerOTELSpanExporter(opentelemetry::sdk::trace::SpanExporter *exporter)
    {
        if (globalOTELTracerProviderInstalled_)
        {
            logger_.warn()
                << "[OttreliteInteropOTEL::registerOTELSpanExporter] OTEL TracerProvider has already been registered! "
    ...
    void OttreliteInteropOTEL::unregisterOTELSpanExporter(opentelemetry::sdk::trace::SpanExporter *exporter)
    {
        otelSpanExporters_.erase(std::remove(otelSpanExporters_.begin(), otelSpanExporters_.end(), exporter),
                                 otelSpanExporters_.end());
    }

    void OttreliteInteropOTEL::registerOTELMetricExporter(opentelemetry::sdk::metrics::PushMetricExporter *exporter)
    {
        if (globalOTELMeterProviderInstalled_)
        {
            logger_.warn()
                << "[OttreliteInteropOTEL::registerOTELMetricExporter] OTEL MeterProvider has already been registered! "
    ...
    void OttreliteInteropOTEL::unregisterOTELMetricExporter(opentelemetry::sdk::metrics::PushMetricExporter *exporter)
    {
    ...
    void OttreliteInteropOTEL::registerOTELLogRecordExporter(opentelemetry::sdk::logs::LogRecordExporter *exporter)
    {
        if (globalOTELLoggerProviderInstalled_)
        {
            logger_.warn() << "[OttreliteInteropOTEL::registerOTELLogRecordExporter] OTEL LoggerProvider has already "
                              "been registered! "
    ...
    void OttreliteInteropOTEL::unregisterOTELLogRecordExporter(opentelemetry::sdk::logs::LogRecordExporter *exporter)
    {
    ...
    void OttreliteInteropOTEL::installGlobalOTELTracerProvider()
    {
        if (globalOTELTracerProviderInstalled_)
        {
            logger_.error() << "[OttreliteInteropOTEL::installGlobalOTELTracerProvider] OTEL TracerProvider has "
    ...
    void OttreliteInteropOTEL::installGlobalOTELMeterProvider()
    {
        if (globalOTELMeterProviderInstalled_)
        {
            logger_.error() << "[OttreliteInteropOTEL::installGlobalOTELMeterProvider] OTEL MeterProvider has already "
                               "been registered! "
                               "Skipping this call.";
            return;
        }
    ...
    void OttreliteInteropOTEL::installGlobalOTELLoggerProvider()
    {
        if (globalOTELLoggerProviderInstalled_)
        {
            logger_.error() << "[OttreliteInteropOTEL::installGlobalOTELLoggerProvider] OTEL LoggerProvider has "
                               "already been registered! "
                               "Skipping this call.";
            return;
        }
    ...
    ExportResult OttreliteInteropOTEL::exportSpans(const std::vector<SerializedReadableSpan> &spans)
    {
        ...
        {
            auto exporterResult = ::ottrelite::interop::otel::OTELExporterAdapterUtils::exportInternalSpansReprsViaOTEL(
    ...
    std::vector<opentelemetry::sdk::trace::SpanExporter *> OttreliteInteropOTEL::otelSpanExporters_;
    std::vector<opentelemetry::sdk::metrics::PushMetricExporter *> OttreliteInteropOTEL::otelMetricExporters_;
    std::vector<opentelemetry::sdk::logs::LogRecordExporter *> OttreliteInteropOTEL::otelLogRecordExporters_;

    opentelemetry::sdk::trace::BatchSpanProcessorOptions OttreliteInteropOTEL::otelBatchSpanProcessorOptions_;
    opentelemetry::sdk::metrics::PeriodicExportingMetricReaderOptions OttreliteInteropOTEL::otelMetricReaderOptions_;
    opentelemetry::sdk::logs::BatchLogRecordProcessorOptions OttreliteInteropOTEL::otelBatchLogRecordProcessorOptions_;

    logging::Logger OttreliteInteropOTEL::logger_{"OttreliteInteropOTEL"};

    bool OttreliteInteropOTEL::globalOTELTracerProviderInstalled_{false};
    bool OttreliteInteropOTEL::globalOTELMeterProviderInstalled_{false};
    bool OttreliteInteropOTEL::globalOTELLoggerProviderInstalled_{false};
} // namespace ottrelite::interop::otel
